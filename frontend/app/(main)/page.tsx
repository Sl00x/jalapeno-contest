...
export default function Home() {
  return (
    <div className="flex flex-col">
      <div className="px-20 mt-20 p-10">
          ...
          <div className="flex flex-col space-y-10 justify-center">
            ...
            <div className="flex flex-row justify-between items-center mt-10">
              <div className="flex flex-col space-y-2">
                <span className="font-bold text-3xl">1.5K +</span>
                <span className="text-xl opacity-50">Contest</span>
              </div>
              <div className="flex flex-col space-y-2">
                <span className="font-bold text-3xl">10 +</span>
                <span className="text-xl opacity-50">Creators</span>
              </div>
              <div className="flex flex-col space-y-2">
                <span className="font-bold text-3xl">500 +</span>
                <span className="text-xl opacity-50">Winners</span>
              </div>
            </div>
      ...
      <section className="p-20 bg-stone-100 h-full">
